...
const FlashcardManager = ({documentId}) => {
    ...
    const handleToggleStar = async (cardId) => {
        ...
        try {
            ...
            toast.success(
                "Flashcard starred status updated!"
            );
            ...
            return (
                ...
                <div className="flex flex-col items-center justify-center py-16 px-6">
                    ...
                    <p className="text-sm text-slate-500 text-center max-w-sm">
                        Generate flashcards from your document to
                        start learning and reinforce your knowledge.
                    </p>

                    <button
                        onClick={handleGenerateFlashcards}
                        disabled={generating}
                        className="group inline-flex items-center gap-2 px-6 h-12 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-sm shadow-lg shadow-emerald-500/25 transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100"
                    >
            ...
            >
                ...
                <div className="space-y-6">
                    ...
                    <p className="text-sm text-slate-600">
                        ...
                        undone and all cards will be permanently
                        removed.
                    ...
                    <div className="flex items-center justify-end gap-3 pt-2">
                        ...
                        <button
                            ...
                            disabled={deleting}
                            className="px-5 h-11 bg-gradient-to-r from-rose-500 to-red-500 hover:from-rose-600 hover:to-red-600 text-white font-semibold text-sm rounded-xl shadow-lg shadow-rose-500/25 disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100 transition-all duration-200"
                        >
