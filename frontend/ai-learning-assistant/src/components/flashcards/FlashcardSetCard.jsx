...
const FlashcardSetCard=({ flashcardSet }) => {
    ...
    const reviewedCount=
        flashcardSet.cards.filter(card => card.lastReviewed).length;
            ...
            <div className="space-y-4">
                ...
                <div className="mt-6 pt-4 border-t border-slate-100">
                    <button
                        ...
                        className="group/btn relative w-full h-11 bg-gradient-to-r from-emerald-50 to-teal-100 hover:from-emerald-700 hover:to-teal-600 hover:text-white font-semibold text-sm rounded-xl transition-all duration-200 active:scale-95 overflow-hidden"
                    >
                        ...
                        <div
                            className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 -translate-x-full group-hover/btn:translate-x-full transition-transform duration-700"
                        />
                    </button>
                </div>
