        ...
        <div>
            <div className="mb-4">
                <Link
                    ...
                    className="inline-flex items-center gap-2 text-sm text-neutral-600 hover:text-neutral-900 transition-color"
                >
                    <ArrowLeft size={16} />
                    Back to Document
                </Link>
            ...
            >
                <div className="space-y-4">
                    <p className="text-sm text-neutral-600">
                        ...
                        for this document? This action cannot be undone.
                    </p>
