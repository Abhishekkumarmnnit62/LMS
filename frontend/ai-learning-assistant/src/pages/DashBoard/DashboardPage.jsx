            ...
            <div className="relative max-w-7xl mx-auto p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    {stats.map((stat,index)=>(
                        ...
                        <div
                            key={index}
                            className="group relative bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl p-6 shadow-xl shadow-slate-200/50 hover:shadow-2xl hover:shadow-slate-300/50 transition-all duration-300 hover:-translate-y-1"
                        >
                            ...
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <div
                                    className={`w-11 h-11 rounded-2xl bg-gradient-to-br ${stat.gradient} shadow-lg ${stat.shadowColor} flex items-center justify-center`}
                                >
                ...
                {/* Recent Activity */}
                <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/40 p-8">
