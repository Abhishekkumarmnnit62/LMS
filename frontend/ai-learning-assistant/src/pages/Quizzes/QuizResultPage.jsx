    ...
    return (
      <div className="max-w-5xl mx-auto px-6 py-8">
        <div className="text-center p-12 bg-white rounded-3xl border border-gray-100 shadow-sm">
          <p className="text-gray-500 text-lg">Quiz results not found.</p>
        </div>
      </div>
    );
  }
...
console.log("Score:",score);
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      {/* Main Centered Score Card */}
      <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl p-10 shadow-xl shadow-slate-200/50 mb-8">
        {/* Trophy Badge */}
        <div className="text-center space-y-6">
          <div className=" inline-flex items-center justify-center w-15 h-15 rounded-2xl bg-linear-to-r from-emerald-100 to-teal-100   shadow-lg shadow-emerald-500/20">
        ...
        {/* Horizontal Status Pills Section */}
        <div className="flex items-center justify-center gap-4 pt-4">
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-emerald-50 border border-emerald-200 rounded-xl ">
            ...
            <span className='text-sm font-semibold text-slate-700'>{correctAnswers} Correct</span>
          </div>

          <div className="flex items-center gap-2  px-4 py-2 bg-rose-50 border border-rose-200 rounded-xl ">
            <XCircle className="w-4 h-4 text-rose-600" />
            <span className='text-sm font-semibold text-slate-700'>{incorrectAnswers} Incorrect</span>
          </div>
        </div>
      </div>
      </div>

      {/* Detailed Review Divider Title */}
            ...
            <div key={index} className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl p-6 shadow-lg shadow-slate-200/50">
              ...
              <div className="flex items-start justify-between gap-4 mb-3">
                <div className="flex-1">
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-slate-50 border border-slate-200 rounded-xl mb-3">
                    <span className="text-xs font-semibold text-slate-900">
                      Question {index + 1}
                    </span>
                  </div>
                  <h4 className="text-md md:text-lg font-bold text-gray-900 tracking-tight leading-snug">
                    {result.question}
                  </h4>
                </div>
              ...
              {result.explanation && (
                ...
                <div className=" flex items-start gap-3">
                  <div className=" shrink-0 w-8 h-8 rounded-lg bg-slate-200  flex items-center justify-center mb-0.5 ">
